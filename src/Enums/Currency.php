...
namespace Apilayer\Currencylayer\Enums;

/**
 * List of supported by Apilayer currencies and precious metals.
 *
 * @link https://currencylayer.com/currencies
 */
abstract class Currency
{
     ...
     * @psalm-var list<self::*>
     */
    private static array $AVAILABLE_CURRENCIES = [];

    /**
     * @psalm-return non-empty-list<self::*>
     */
    public static function getAvailableCurrencies(): array
    {
        if (self::$AVAILABLE_CURRENCIES === []) {
            /** @psalm-var non-empty-list<self::*> $currencies */
            $currencies = [
                self::AED,
                self::AFN,
                self::ALL,
